<template>
  <svg id="svg2" xmlns="http://www.w3.org/2000/svg" viewBox="504.6 66.3 83.1 68.8">
    <defs>
      <linearGradient id="rect3405_1_" gradientUnits="userSpaceOnUse" x1="468.012" y1="65.378" x2="487.678" y2="55.896"
                      gradientTransform="matrix(1 0 0 -1 81.423 161.063)">
        <stop offset="0" stop-color="#cd090d"/>
        <stop offset="1" stop-color="#f39272"/>
      </linearGradient>
      <linearGradient id="path4195_1_" gradientUnits="userSpaceOnUse" x1="540.972" y1="144.663" x2="540.972" y2="141.689"
                      gradientTransform="matrix(1 0 0 -1 3.19 212.758)">
        <stop offset="0" stop-color="#fff"/>
        <stop offset=".3" stop-color="#fff" stop-opacity=".498"/>
        <stop offset="1" stop-color="#fff" stop-opacity="0"/>
      </linearGradient>
      <linearGradient id="rect3405-9_1_" gradientUnits="userSpaceOnUse" x1="423.666" y1="66.686" x2="472.845" y2="66.686"
                      gradientTransform="matrix(1 0 0 -1 81.409 161.092)">
        <stop offset="0" stop-color="#8e0902"/>
        <stop offset="1" stop-color="#e2080e"/>
      </linearGradient>
      <linearGradient id="rect3405-9-5_1_" gradientUnits="userSpaceOnUse" x1="462.714" y1="40.159" x2="462.714"
                      y2="44.876" gradientTransform="matrix(1 0 0 -1 81.416 161.084)">
...
.st4 {
  fill: url(#rect3405-9-5_1_);
}

.st5 {
  fill: url(#path5068-1_1_);
}

.st6 {
  fill: url(#path4979-7_1_);
}

.st7 {
  fill: url(#path5118-2_1_);
}

.st8 {
  fill: url(#path5244_1_);
}
